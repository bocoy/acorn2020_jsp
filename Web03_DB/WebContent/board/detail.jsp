...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//GET  방식 파라미터로 전달괴는 자세히 보여줄 글의 번호 읽어오기 ?num=xx
...
<body>
	...
	<table class="table table-hover table-striped table-dark">
		...
		<tr>
			<th>내용</th>
			<td><textarea cols="20" rows="5" disabled class="form-control"><%=dto.getContent() %></textarea></td>
		</tr>
		<tr>
			<td></td>
			<td>
				<a href="updateform.jsp?num=<%=dto.getNum()%>" class="badge badge-primary">수정</a>
				<a href="javascript:deleteConfirm(<%=dto.getNum()%>)" class="badge badge-danger">삭제</a>
			</td>
		</tr>
	</table>
	</div>
